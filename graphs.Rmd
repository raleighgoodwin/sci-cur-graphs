...
### co2 plot
```{r}
# co2plot_df$title1 <- "Average Atmospheric CO"
# co2plot_df$title2 <- "Levels\n1980-2021"
co2plot_df$title <- as.character(expression(paste("Average Atmospheric ", CO[2], " Levels\n1980-2021")))

x <- expression(paste("Average Atmospheric ", CO[2], " Levels\n1980-2021"))

# co2title <- as_labeller(c(`0` = expression(paste("Average Atmospheric ", CO[2], " Levels\n1980-2021"))))

# deparse(expression(paste("Average Atmospheric ", CO[2], " Levels\n1980-2021")))
